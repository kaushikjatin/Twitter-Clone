    ...
    render(){
        ...
        return(
            <Container>
                ...
                <Nav.Item>
                    <Nav.Link eventKey="link-1" as={Link} to="/all_users">All Users</Nav.Link>
                </Nav.Item>

                    {
                        currentUser?
                        (   <NavDropdown title={currentUser} id="nav-dropdown">
                                <NavDropdown.Item eventKey="4.1" as={Link} to="/user/videos">G o To Your Status</NavDropdown.Item>
                      </NavDropdown>
                       ):
                        (<span></span>)
                    }
